...
public class CommonAreaController
	extends BaseController<CommonAreaService, CommonAreaVO> {


    @PostMapping("/add")
    @ApiOperation(value = "添加", notes = "添加")
    @Override
    protected Result add(@RequestBody @Validated CommonAreaVO dto) {
        service.save(dto);
    ...
    @Override
    protected Result edit(@RequestBody @Validated CommonAreaVO dto) {
    ...
    @PostMapping("/page")
    @Override
    protected Result page(@RequestBody @Validated CommonAreaVO dto) {

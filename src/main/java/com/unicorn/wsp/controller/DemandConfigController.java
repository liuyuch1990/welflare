...
public class DemandConfigController
	extends BaseController<DemandConfigService, DemandConfigVO> {


    @PostMapping("/add")
    @ApiOperation(value = "添加", notes = "添加")
    @Override
    protected Result add(@RequestBody @Validated DemandConfigVO dto) {
        service.save(dto);
    ...
    @Override
    protected Result edit(@RequestBody @Validated DemandConfigVO dto) {
    ...
    @PostMapping("/page")
    @Override
    protected Result page(@RequestBody @Validated DemandConfigVO dto) {

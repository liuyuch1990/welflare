...
@Api(tags = {""})
@RequestMapping("/role")
public class WspRoleController
	extends BaseController<WspRoleService, WspRoleVO> {


    @PostMapping("/add")
    @ApiOperation(value = "添加", notes = "添加")
    @Override
    protected Result add(@RequestBody @Validated WspRoleVO dto) {
        service.save(dto);
    ...
    @Override
    protected Result edit(@RequestBody @Validated WspRoleVO dto) {
    ...
    @PostMapping("/page")
    @Override
    protected Result page(@RequestBody @Validated WspRoleVO dto) {

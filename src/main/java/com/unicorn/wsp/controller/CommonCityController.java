...
public class CommonCityController
	extends BaseController<CommonCityService, CommonCityVO> {


    @PostMapping("/add")
    @ApiOperation(value = "添加", notes = "添加")
    @Override
    protected Result add(@RequestBody @Validated CommonCityVO dto) {
        service.save(dto);
    ...
    @Override
    protected Result edit(@RequestBody @Validated CommonCityVO dto) {
    ...
    @PostMapping("/page")
    @Override
    protected Result page(@RequestBody @Validated CommonCityVO dto) {

...
public class WspRoleMenuController
	extends BaseController<WspRoleMenuService, WspRoleMenuVO> {


    @PostMapping("/add")
    @ApiOperation(value = "添加", notes = "添加")
    @Override
    protected Result add(@RequestBody @Validated WspRoleMenuVO dto) {
        service.save(dto);
    ...
    @Override
    protected Result edit(@RequestBody @Validated WspRoleMenuVO dto) {
    ...
    @PostMapping("/page")
    @Override
    protected Result page(@RequestBody @Validated WspRoleMenuVO dto) {

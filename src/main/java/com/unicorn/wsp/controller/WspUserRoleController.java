...
public class WspUserRoleController
	extends BaseController<WspUserRoleService, WspUserRoleVO> {


    @PostMapping("/add")
    @ApiOperation(value = "添加", notes = "添加")
    @Override
    protected Result add(@RequestBody @Validated WspUserRoleVO dto) {
        service.save(dto);
    ...
    @Override
    protected Result edit(@RequestBody @Validated WspUserRoleVO dto) {
    ...
    @PostMapping("/page")
    @Override
    protected Result page(@RequestBody @Validated WspUserRoleVO dto) {

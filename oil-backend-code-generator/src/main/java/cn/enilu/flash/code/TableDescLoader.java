...
//        DataSource ds = ioc.get(DataSource.class);
        ...
        ds.setJdbcUrl("jdbc:mysql://47.93.51.187:3306/welfare_shopping_platform?useUnicode=true&characterEncoding=utf-8&useSSL=false");
        ds.setUsername("root");
        ds.setPassword("123@qweQWE");
        try {
        ...
        for (Map<String, Object> columnInfo : columns) {
            ...
            if ("create_by".equals(column.columnName) || "modify_by".equals(column.columnName)
                    || "modify_time".equals(column.columnName)) {
                continue;
            }
